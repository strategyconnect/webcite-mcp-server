 ...
 * number_inventory / resolve_seeds replay pin — refuse before HTTP (same identityComplete honesty
 ...
 * number_inventory (#112), formal_resolution_state (#113), and resolve_seeds
 * (W2). Omit when not a
