    ...
    inputSchema: {
      ...
      properties: {
        ...
        idempotency_key: {
          type: 'string',
          description:
            'Optional. When string: non-blank unpadded; blank/whitespace/surrounding-padded → incomplete_operation_idempotency_identity (never trim-launder into an attempt-record replay pin).',
        },
      },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        idempotency_key: {
          type: 'string',
          description:
            'Optional. When string: non-blank unpadded; blank/whitespace/surrounding-padded → incomplete_operation_idempotency_identity (never trim-launder into an attempt-resolve replay pin).',
        },
      },
