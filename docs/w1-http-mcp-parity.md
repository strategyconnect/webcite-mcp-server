...
| `get_change_impact` | `POST /api/v2/context/change-impact` | answer_revision_id and/or changed_ids (+ links/packet_id/window); blank/whitespace/padded ids → `incomplete_changed_ids` | freshness and/or packet_impact | integrity / `change_impact_incomplete` | 0 | answer sources / packet consumers |
