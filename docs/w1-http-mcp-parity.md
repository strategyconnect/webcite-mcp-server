...
| `query_context` | `POST /api/v2/context/query` | text, source_texts/ids, filters (non-blank/unpadded) | refs + plan + presentation | `refuse` ≠ HTTP error; blank/padded filters → `padded_lookup_filter` (#307) | 0 | sourceVersionId / nodeId |
